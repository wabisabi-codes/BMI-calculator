alert("Hello! Thank you for visiting A Better BMI, we are excited to help you discover a better you! You can click the contact button on any personal trainer below to get more information about our special programs!");
...
/*function calculate(){
	...
	document.getElementById("weight-val").textContent= weight + " lbs";
